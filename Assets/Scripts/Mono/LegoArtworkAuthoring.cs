...
public class LegoArtworkAuthoring : MonoBehaviour
{
    ...
    private class Baker : Unity.Entities.Baker<LegoArtworkAuthoring>
    {
        public override void Bake(LegoArtworkAuthoring authoring)
        {
            ...
            foreach(var transform in transforms)
            {
                ...
                // manager.SetComponentData(entity, new LocalTransform(){Position = new float3(transform.position)});
            }
        }
    }
}